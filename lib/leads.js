...
// --- Fetch contacts created on or after March 30, 2026 ---
async function fetchAllContacts() {
  ...
  const cutoffDate = new Date("2026-03-30T00:00:00.000Z");
        ...
        for (const assoc of resp.results) {
          try {
            ...
            engagements.push({
              ...
              isLogged: callSource === "CRM_UI" || callSource === "INTEGRATIONS" || (!callSource && !props.hs_call_recording_url),
...
function processContact(contact, engagements) {
  ...
  return {
    ...
    lastTouch: lastEngagement
      ...
      : null,
    analyticsSource: props.hs_analytics_source || null,
    analyticsSourceData1: props.hs_analytics_source_data_1 || null,
    analyticsSourceData2: props.hs_analytics_source_data_2 || null,
    isPowerAutomate: props.hs_analytics_source_data_1 === "INTEGRATION",
    engagements,
